...
train_dir = os.path.join(base_dir, 'Train_Green')
test_dir = os.path.join(base_dir, 'Test_Green')
...
def test_model(name=""):
    ...
    if not os.path.exists(model_out_dir):
        ...
        exit(0)
    model = tf.keras.models.load_model(model_out_dir + "/model_green.h5")

    image = cv2.imread(test_dir + '/Banana/322_100.jpg')
