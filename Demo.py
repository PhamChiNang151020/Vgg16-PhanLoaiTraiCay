...
from keras.distribute.distributed_training_utils_v1 import validate_callbacks
...
test_dir = os.path.join(base_dir, 'Test') #(Apple golden: 192 , apple red: 198, Banana: 198, Banana red: 198, Lemon: 198) = 984
train_dir = os.path.join(base_dir, 'Training') # (Apple golden: 448 , apple red: 461, Banana:458 , Banana red: 458, Lemon: 458) =2283
